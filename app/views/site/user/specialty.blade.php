    ...
    <script type="text/javascript">
        ...
        //Set up "Bloodhound" Options 
			...
			function help() {
			  ...
			  console.log("In the function, bitches!");
			}
...
<div class="sub-header">
		...
		<div class="container">
					...
					<div class="row" style = "background-color: white;">
						<div class="col-md-12 heading">
							<div id = "results" class="col-md-12 col-xs-12 results">
								...
								<button class="btn go-btn" id="help" onclick="help()" type="button" data-toggle="chardinjs" data-intro="This button toggles the overlay, you can click it, even when the overlay is visible" data-position="right">HELP?</button>
							</div>
						</div>
					</div>
				</div>
			...
			<div id ="webPlayer" class="col-md-12 col-xs-12" style = "padding: 0px;" data-intro="You could filter data according to <b>Month or Year</b>. You could also filter the <b>number of top physicians or top companies shown</b>." data-position="left" data-position="right"></div>
